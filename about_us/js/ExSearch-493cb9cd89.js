...
var ModalHelper = {
    ...
    beforeModal: function() {
        ModalHelper.scrollTop = document.scrollingElement.scrollTop, document.body.classList.add("es-modal-open"), document.body.style.top = -ModalHelper.scrollTop + "px"
    },
    closeModal: function() {
        document.body.classList.remove("es-modal-open"), document.scrollingElement.scrollTop = ModalHelper.scrollTop
    }
};
! function(i, c) {
    var t = i(".ins-search"),
            ...
            case "PAGES":
                r = t.map(function(t) {
                    var n = 20 < t.firstOccur ? t.firstOccur - 20 : 0,
                        a = "";
                    return delete t.firstOccur, s.forEach(function(n) {
                        var e = new RegExp(n, "gi");
                        a = t.text.replace(e, '<mark class="search-keyword"> ' + n + " </mark>")
                    }), a = a ? a.slice(n, n + 80) : t.text.slice(0, 80), l("file", t.title, null, a, c.ROOT_URL + t.path)
                });
                break;
            case "CATEGORIES":
            case "TAGS":
    ...
    function h(n) {
        ...
        i(e[t]).removeClass("active"), i(e[a]).addClass("active"),
            function(n) {
                if (0 !== n.length) {
                    var e = r[0].clientHeight,
                        t = n.position().top - r.scrollTop(),
                        a = n[0].clientHeight + n.position().top;
                    a > e + r.scrollTop() && r.scrollTop(a - r[0].clientHeight), t < 0 && r.scrollTop(n.position().top)
                }
            }(i(e[a]))
    }
    ...
    t.parent().remove(".ins-search"), i("body").append(t), i.getJSON(c.CONTENT_URL, function(e) {
        "#ins-search" === location.hash.trim() && (t.addClass("show"), ModalHelper.beforeModal()), n.on("input", function() {
            var n = i(this).val();
            ! function(n, e) {
                for (var t in o.empty(), e) o.append(a(n, t.toUpperCase(), e[t]))
            }(n, s(e, n))
        }), n.trigger("input")
    }), i(document).on("click focus", ".search-form-input", function() {
        t.addClass("show"), ModalHelper.beforeModal(), document.scrollingElement.scrollTop = 0, t.find(".ins-search-input").focus()
    }).on("click", ".ins-search-item", function() {
        "function" == typeof ExSearchCall ? ExSearchCall(i(this)) : T(i(this))
    }).on("click", ".ins-close", function() {
        t.removeClass("show"), ModalHelper.closeModal()
        ...
        if (t.hasClass("show")) switch (n.keyCode) {
            ...
            case 13:
                ...
                "function" == typeof ExSearchCall ? ExSearchCall(e) : T(e)
        }
    })
